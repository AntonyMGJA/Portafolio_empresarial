...
const SkillsList = () => {
  ...
  const skills = {
    "Desarrollo web": [
      ...
      "Páginas de destino y sitios web comerciales",
      "Sitios web de portafolio y blogs",
    ],
    "Desarrollo movil": [
      "Aplicaciones web optimizadas para dispositivos móviles",
      "Aplicaciones móviles de React Native",
    ],
    "Diseño y prototipos UI/UX": [
      "Diseño de interfaz de usuario con Figma y Canva",
      "Investigación y mejoras de UX",
      "Creación de prototipos para sitios web y aplicaciones móviles",
    ],
  };
